...
defects_ncount_by_week <-
  ...
  line_plot.NumClosed_For_FloorDate(defects_ncount_by_week, plt_caption="Closure per Week for All Defects", pal_option="D")
```
...
tib_defects.closed %>% violin_plot.CycleTimeVsPriority(pal_option = 'D')
```
