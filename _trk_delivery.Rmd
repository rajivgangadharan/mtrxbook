...
work items that flowed in across different projects and priorities.


```{r trk-summary-treemap-data, include=FALSE, echo=FALSE}

tib_treemap <- tib.all %>% group_by(Project, Priority) %>% summarize(Count= n())

```

```{r trk-summary-treemap-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Summary Tree Map", echo=FALSE, message = FALSE}

treemap_d3(tib_treemap = tib_treemap, title = "Distribution of priorities across projects")
