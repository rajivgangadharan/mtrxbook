...
```{r essence-setup, include=FALSE}
# Empty

```

```{r essence-delivery-setup, include=FALSE}
...
```{r essence-stories-summary-treemap-data, include=FALSE, echo=FALSE}
...
```{r essence-stories-summary-treemap-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Summary Tree Map", echo=FALSE, message = FALSE}
...
```{r essence-cycle-time-summ, include=TRUE, out.width='80%', echo=FALSE}
...
```{r essence-epics-cycle-time-trend-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Cycle Time Trend", echo=FALSE}
loess_plot.CycleTimeTrend(epics.closed, col_date="crdt")
```


```{r essence-epics-summary-metrics, include=TRUE, out.width='80%', echo=FALSE}
 tabulate.PriorityBasedCycleTimeStat(epics.closed)
```

#### Stories

```{r essence-stories-cycle-time-trend-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Cycle Time Trend", echo=FALSE}
...
```{r essence-story-summary-metrics, include=TRUE, out.width='80%', echo=FALSE}
...
```{r essence-completed-epics-week-fig, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Closed Epics by Week", echo=FALSE}
...
```{r essence-epics-wk-agg-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r essence-completed-items-week-fig, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r essence-stories-wk-agg-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Number of Stories Closed in a Week colored by Priority", echo=FALSE}
...
```{r essence-density-distibution-closed-stories-fig, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.asp=.75, fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
```{r essence-epics-work-in-progress, include=TRUE, echo=FALSE}
tib_epics_work_in_progress <- tib.all %>%
  dplyr::filter(Type == 'Epic') %>% finmetrics::compute.WIP()

```

<!-- ```{r essence-epics-work-in-progress-fig , include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.cap="WiP in Days", fig.align='center', cache=TRUE} -->
<!-- areaPlot.WiP(tib_epics_work_in_progress) -->
<!-- ``` -->

##### Stories

```{r essence-stories-work-in-progress, include=TRUE, echo=FALSE}
tib_stories_work_in_progress <- tib.all %>%
  dplyr::filter(Type == 'Story') %>% finmetrics::compute.WIP()

```

<!-- ```{r essence-stories-work-in-progress-fig , include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.cap="WiP in Days", fig.align='center', cache=TRUE} -->
...
```{r essence-epics-inflow-outflow, include=TRUE, echo=FALSE, out.width='80%', fig.align="center", fig.asp=.75, eval=TRUE}
flow.epics.merged <- tib.all %>%
  get.InflowOutflowTibble.Epic(include_priority = TRUE)
 bar_plot.InflowOutflow(flow.epics.merged)
```

```{r essence-epics-inflow-outflow-cumsumm, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align="center", eval=TRUE}
line_plot.InflowOutflow.CumSum(flow.epics.merged)
```

```{r essence-epics-inflow-outflow-cumsumm-interactive, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align="center", eval=TRUE}
line_plotly.InflowOutflow.CumSum(flow.epics.merged)
```

```{r essence-epics-inflow-outflow-datatable, include=TRUE, echo=FALSE, out.width='80%',fig.asp=.75, fig.align="center", eval=TRUE }
DT::datatable(flow.epics.merged, filter='top')
```
##### Stories

```{r essence-stories-inflow-outflow, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center',  eval=TRUE}
...
```{r essence-stories-inflow-outflow-cumsumm, out.width='80%', fig.asp=.75, fig.align='center',include=TRUE, echo=FALSE, eval=TRUE}
line_plot.InflowOutflow.CumSum(flow.stories.merged)
```


```{r essence-stories-inflow-outflow-cumsumm-interactive, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align="center", eval=TRUE}
line_plotly.InflowOutflow.CumSum(flow.stories.merged)
```

```{r essence-stories-inflow-outflow-datatable, include=TRUE, echo=FALSE, out.width='80%',fig.asp=.75, fig.align="center", eval=TRUE }
