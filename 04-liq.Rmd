...
```{r liq-epics-work-in-progress, include=TRUE, echo=FALSE}
tib_epics_work_in_progress <- tib.all %>%
  dplyr::filter(Type == 'Epic') %>% finmetrics::compute.WIP()

```

```{r liq-epics-work-in-progress-fig , include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.cap="WiP in Days", fig.align='center', cache=TRUE}
