...
```{r essence-defects-setup, include=FALSE}
# Empty
```


```{r essence-defect-metrics-setup, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE}
tib_defects.all <-
...
```{r essence-defects-summary-treemap-data, include=FALSE, echo=FALSE}

tib_defects_treemap <- tib_defects.all %>% group_by(Project, Priority) %>% 
  summarize(Count= n(), .groups='drop')

```

```{r essence-defects-summary-treemap-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Summary Tree Map", echo=FALSE, message = FALSE}
...
```{r essence-defects-tab-cycle-time-basic-stats, out.width="80%", echo=FALSE, include=TRUE}
...
```{r essence-defects-cycle-time-trend-all, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="All Severities"}
...
```{r essence-defects-cycle-time-summary, include=TRUE, out.width='80%', echo=FALSE}
# tabulate.PriorityBasedCycleTimeStat(tib_defects.closed,
#                                     tab_caption = "All Severities")
tabulate.TypeAndPriorityBasedCycleTimeStat(tib_defects.closed, tab_caption = "All Severities")
```

```{r essence-defects-cycle-time-trend-for-hnc, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="High and Critical"}
...
```{r essence-defects-cycle-time-stat-for-high-and-critical, include=TRUE, echo=FALSE }
...
```{r essence-defects-closed-metric-for-each-week, include=TRUE, echo=FALSE, out.width="80%", fig.asp=0.75, fig.align='center', fig.cap="Closure metrics - All Defects"}
...
```{r essence-defects-fig-completed-hnc-defects-week, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Closed defects by Week", echo=FALSE}
...
```{r essence-defects-wk-agg, include=TRUE, echo=FALSE}
tib_defects_wk_agg <-
  tib_defects.closed %>%
...
```{r essence-defects-all-wk-agg-fig, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - All Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_defects_wk_agg)
```

```{r essence-defects-fig-hnc-wk-agg, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - High and Critical Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_hnc_defects_wk_agg)
```

```{r essence-defects-tab-weekly-aggregate, echo=FALSE}
...
```{r essence-defects-fig-densdist-closed-overall, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
tib_defects.closed %>% violin_plot.CycleTimeVsPriority()
```

```{r essence-defects-fig-densdist-closed-hnc, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
<!-- ```{r essence-defects-fig-areaplot-wip, include=TRUE, echo=FALSE, out.width="80%", fig.asp=.75, fig.caption="Work in Progress", fig.align='center', cache=TRUE} -->
...
```{r essence-defects-inflow-outflow, include=TRUE, echo=FALSE,out.width='80%', fig.asp=.75, fig.align='center', eval=TRUE}
...
```{r essence-defects-inflow-outflow-cumsumm, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center',eval=TRUE}
      line_plot.InflowOutflow.CumSum(flow.defects.merged)

```

```{r essence-defects-inflow-outflow-datatable, include=TRUE, echo=FALSE, out.width='80%',fig.asp=.75, fig.align="center", eval=TRUE }
