...
## Delivery Metrics {#liq}


```{r liq-setup, include=FALSE}
source("./R/common.R")
```

```{r liq-delivery-setup, include=FALSE}
...
tib.all$Priority <- factor(tib.all$Priority, levels=c("Critical","High", "Medium", "Low"), ordered = TRUE)
...
```{r liq-cycle-time-summ, include=TRUE, out.width='80%', echo=FALSE}
...
```{r liq-epics-cycle-time-trend-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Cycle Time Trend", echo=FALSE}
loess_plot.CycleTimeTrend(epics.closed)
```


```{r liq-epics-summary-metrics, include=TRUE, out.width='80%', echo=FALSE}
 tabulate.PriorityBasedCycleTimeStat(epics.closed)
```

#### Stories

```{r liq-stories-cycle-time-trend-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Cycle Time Trend", echo=FALSE}
...
```{r liq-story-summary-metrics, include=TRUE, out.width='80%', echo=FALSE}
...
```{r liq-completed-epics-week-fig, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Closed Epics by Week", echo=FALSE}
...
```{r liq-epics-wk-agg-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r liq-density-distibution-closed-epics-fig, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.asp=.75, fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
```{r liq-completed-items-week-fig, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r liq-stories-wk-agg-fig, include=TRUE, out.width='80%', fig.asp=.75, fig.align='center', fig.cap="Number of Stories Closed in a Week colored by Priority", echo=FALSE}
...
```{r liq-density-distibution-closed-stories-fig, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.asp=.75, fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
```{r liq-stories-work-in-progress, include=TRUE, echo=FALSE}
tib_stories_work_in_progress <- tib.all %>%
  dplyr::filter(Type == 'Story') %>% finmetrics::compute.WIP()

```

```{r liq-stories-work-in-progress-fig , include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.cap="WiP in Days", fig.align='center', cache=TRUE}
...
```{r liq-epics-inflow-outflow, include=TRUE, echo=FALSE, out.width='80%', fig.align="center", fig.asp=.75, eval=TRUE}
flow.epics.merged <- tib.all %>%
  get.InflowOutflowTibble.Epic(include_priority = TRUE)
 bar_plot.InflowOutflow(flow.epics.merged)
```

```{r liq-epics-inflow-outflow-cumsumm, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align="center", eval=TRUE}
line_plot.InflowOutflow.CumSum(flow.epics.merged)
```

##### Stories

```{r liq-stories-inflow-outflow, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center',  eval=TRUE}
flow.stories.merged <- tib.all %>%
  get.InflowOutflowTibble.Story(include_priority = TRUE)
 bar_plot.InflowOutflow(flow.stories.merged)
```

```{r liq-stories-inflow-outflow-cumsumm, out.width='80%', fig.asp=.75, fig.align='center',include=TRUE, echo=FALSE, eval=TRUE}
line_plot.InflowOutflow.CumSum(flow.stories.merged)
```

## Defect Metrics

```{r liq-defects-setup, include=FALSE}
# Empty
```


```{r liq-defect-metrics-setup, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE}
tib_defects.all <-
  finmetrics::get.FilteredTibble(here::here("inst/extdata",
                                            "gpp_defects.csv"),
                                 date_from = Sys.Date() - months(12)) %>%
...
```{r liq-defects-tab-cycle-time-basic-stats, out.width="80%", echo=FALSE, include=TRUE}
...
```{r liq-defects-cycle-time-trend-all, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="All Severities"}
...
```{r liq-defects-cycle-time-summary, include=TRUE, out.width='80%', echo=FALSE}
tabulate.PriorityBasedCycleTimeStat(tib_defects.closed,
                                    tab_caption = "All Severities")
```

```{r liq-defects-cycle-time-trend-for-hnc, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="High and Critical"}
...
```{r liq-defects-cycle-time-stat-for-high-and-critical, include=TRUE, echo=FALSE }
...
```{r liq-defects-closed-metric-for-each-week, include=TRUE, echo=FALSE, out.width="80%", fig.asp=0.75, fig.align='center', fig.cap="Closure metrics - All Defects"}
...
```{r liq-defects-fig-completed-hnc-defects-week, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Closed defects by Week", echo=FALSE}
...
```{r liq-defects-wk-agg, include=TRUE, echo=FALSE}
tib_defects_wk_agg <-
  tib_defects.closed %>%
...
```{r liq-defects-all-wk-agg-fig, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - All Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_defects_wk_agg)
```

```{r liq-defects-fig-hnc-wk-agg, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - High and Critical Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_hnc_defects_wk_agg)
```

```{r liq-defects-tab-weekly-aggregate, echo=FALSE}
...
```{r liq-defects-fig-densdist-closed-overall, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
tib_defects.closed %>% violin_plot.CycleTimeVsPriority(pal_option = 'B')
```

```{r liq-defects-fig-densdist-closed-hnc, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
```{r liq-defects-fig-areaplot-wip, include=TRUE, echo=FALSE, out.width="80%", fig.asp=.75, fig.caption="Work in Progress", fig.align='center', cache=TRUE}
...
```{r liq-defects-inflow-outflow, include=TRUE, echo=FALSE,out.width='80%', fig.asp=.75, fig.align='center', eval=TRUE}
...
```{r liq-defects-inflow-outflow-cumsumm, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center',eval=TRUE}
