...
line_plot.NumClosed_For_FloorDate(
  gen_ds.NumClosed_For_FloorDate(epics.closed), show_trend = TRUE
)
...
line_plot.NumClosed_For_FloorDate(
  gen_ds.NumClosed_For_FloorDate(stories.closed), show_trend = TRUE
)
...
defects_ncount_by_week <-
  ...
  line_plot.NumClosed_For_FloorDate(defects_ncount_by_week, plt_caption="Closure per Week for All Defects", show_trend = TRUE)
```
...
line_plot.NumClosed_For_FloorDate(hnc_defects_ncount_by_week, plt_caption="Closure per Week - High and Critical Defects", show_trend = TRUE)
```
