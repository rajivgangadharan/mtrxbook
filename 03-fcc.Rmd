# Fusion Corporate Channels (FCC)

## Delivery Metrics {#fcc}
...
```{r fcc-defects-setup, include=FALSE}
# Empty
```


```{r fcc-defect-metrics-setup, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE}
tib_defects.all <-
  finmetrics::get.FilteredTibble(here::here("inst/extdata",
                                            "fcc_defects.csv"),
                                 date_from = Sys.Date() - months(12)) %>%
...
```{r fcc-defects-tab-cycle-time-basic-stats, out.width="80%", echo=FALSE, include=TRUE}
...
```{r fcc-defects-cycle-time-trend-all, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="All Severities"}
...
```{r fcc-defects-cycle-time-summary, include=TRUE, out.width='80%', echo=FALSE}
tabulate.PriorityBasedCycleTimeStat(tib_defects.closed,
                                    tab_caption = "All Severities")
```

```{r fcc-defects-cycle-time-trend-for-hnc, include=TRUE, echo=FALSE , out.width='80%', fig.asp=.75, fig.align='center', fig.cap="High and Critical"}
...
```{r fcc-defects-cycle-time-stat-for-high-and-critical, include=TRUE, echo=FALSE }
...
```{r fcc-defects-closed-metric-for-each-week, include=TRUE, echo=FALSE, out.width="80%", fig.asp=0.75, fig.align='center', fig.cap="Closure metrics - All Defects"}
...
```{r fcc-defects-fig-completed-hnc-defects-week, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "Closed defects by Week", echo=FALSE}
...
```{r fcc-defects-wk-agg, include=TRUE, echo=FALSE}
tib_defects_wk_agg <-
  tib_defects.closed %>%
...
```{r fcc-defects-all-wk-agg-fig, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - All Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_defects_wk_agg)
```

```{r fcc-defects-fig-hnc-wk-agg, include=TRUE, echo=FALSE, out.width="80%", fig.caption="Closure Count - High and Critical Priorities", fig.asp=0.75, fig.align="center"}
bar_plot.NumClosed_For_FloorDate(tib_hnc_defects_wk_agg)
```

```{r fcc-defects-tab-weekly-aggregate, echo=FALSE}
...
```{r fcc-defects-fig-densdist-closed-overall, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
tib_defects.closed %>% violin_plot.CycleTimeVsPriority(pal_option = 'B')
```

```{r fcc-defects-fig-densdist-closed-hnc, include=TRUE, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Priority based Density Distribution", message=FALSE, warning=FALSE}
...
```{r fcc-defects-fig-areaplot-wip, include=TRUE, echo=FALSE, out.width="80%", fig.asp=.75, fig.caption="Work in Progress", fig.align='center', cache=TRUE}
...
```{r fcc-defects-inflow-outflow, include=TRUE, echo=FALSE,out.width='80%', fig.asp=.75, fig.align='center', eval=TRUE}
...
```{r fcc-defects-inflow-outflow-cumsumm, include=TRUE, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center',eval=TRUE}
